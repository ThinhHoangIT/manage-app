...
const listSlice = createSlice({
  ...
  reducers: {
    ...
    addMemberChecklistItemOfCard: (state, action) => {
      const {
        listId,
        cardId,
        checklistId,
    ...
    deleteMemberChecklistItemOfCard: (state, action) => {
      const { listId, cardId, checklistId, checklistItemId, memberId } =
        action.payload;
      state.allLists = state.allLists.map((list) => {
        if (list._id === listId) {
          list.cards = list.cards.map((card) => {
...
export const {
  ...
  deleteMemberChecklistItemOfCard,
